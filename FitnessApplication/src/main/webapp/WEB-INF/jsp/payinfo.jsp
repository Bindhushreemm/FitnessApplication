	...
	<div class="container">
		<div class="card">
			<div class="card_title">
				<h1>One step to get delivery!</h1>
				
			</div>
			<div class="form">
				<form action="/confirmorder" method="post" modelAttribute="co">
					enter the username: <input type="text" name="uname" path="username"><br>
					<br> enter the address: <input type="text" name="address"
						path="address"><br>
					<br> enter the email: <input type="text" name="email"
						path="email"><br>
					<br> enter the phono: <input type="tel" name="phono"
						path="phono"><br>
					<br> Quantity:<br><input type="number" name="quantity" min="1" max="10"><br>
			...
			<div class="card_terms">
				<input type="checkbox" name="" id="terms"> <span>I
