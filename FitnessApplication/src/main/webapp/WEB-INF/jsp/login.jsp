...
<form:form action="/ulogin" method="post" modelAttribute="info">
<div>
...
<div class="container">
      <div class="card">
        <div class="card_title">
          ...
          <span>New User? <a href="signup" style="color:red;">Signup</a></span>
        </div>
        <div class="form">
        <form action="/ulogin" method="post" modelAttribute="info">
